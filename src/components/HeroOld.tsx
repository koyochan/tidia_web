...
export default function Hero() {
  ...
  return (
    ...
    <div className="relative w-full h-screen overflow-hidden bg-[#1A1A1A] font-sans">
      ...
      <section className="board w-screen h-screen flex flex-col perspective-1000 bg-[#1A1A1A] relative z-[1] p-0.5 gap-0.5">
        {[...Array(ROWS)].map((_, rowIndex) => (
          <div key={rowIndex} className="row flex flex-1 gap-0.5">
            {[...Array(COLS)].map((_, colIndex) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div 
                    className="tile-face tile-back absolute inset-0 backface-hidden rotate-x-180 rounded-lg"
                    style={{ 
